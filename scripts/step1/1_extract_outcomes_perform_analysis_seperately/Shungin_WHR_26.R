...
outcome_data_shin <- read.table("002_adiposity_metabolites/analysis/step1/WHR_Shungin_26//outcome_data_shin.txt", header = T, sep = "\t")
outcome_data_kettunen <- read.table("002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/outcome_data_kettunen.txt", header = T, sep = "\t")
...
### save plots ====
pdf("002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/plot_mr_scatter_shin.pdf")
for (i in 1:length(plot_mr_scatter_shin)) {
  print(plot_mr_scatter_shin[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/plot_singlesnp_forest_shin.pdf")
for (i in 1:length(plot_singlesnp_forest_shin)) {
  print(plot_singlesnp_forest_shin[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/plot_leaveoneout_forest_shin.pdf")
for (i in 1:length(plot_leaveoneout_forest_shin)) {
  print(plot_leaveoneout_forest_shin[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/plot_mr_funnel_shin.pdf")
for (i in 1:length(plot_mr_funnel_shin)) {
  print(plot_mr_funnel_shin[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/plot_mr_scatter_kettunen.pdf")
for (i in 1:length(plot_mr_scatter_kettunen)) {
  print(plot_mr_scatter_kettunen[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/plot_singlesnp_forest_kettunen.pdf")
for (i in 1:length(plot_singlesnp_forest_kettunen)) {
  print(plot_singlesnp_forest_kettunen[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/plot_leaveoneout_forest_kettunen.pdf")
for (i in 1:length(plot_leaveoneout_forest_kettunen)) {
  print(plot_leaveoneout_forest_kettunen[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/plot_mr_funnel_kettunen.pdf")
...
## Save output ====
write.table(exposure_data, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/exposure_data.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(harmonise_data_shin, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/harmonise_data_shin.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(harmonise_data_kettunen, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/harmonise_data_kettunen.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_results_shin, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/mr_results_shin.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_results_kettunen, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/mr_results_kettunen.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_singlesnp_shin, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/mr_singlesnp_shin.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_singlesnp_kettunen, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/mr_singlesnp_kettunen.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_hetrogeneity_shin, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/mr_hetrogeneity_shin.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_hetrogeneity_kettunen, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/mr_hetrogeneity_kettunen.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_pleiotropy_shin, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/mr_pleiotropy_shin.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_pleiotropy_kettunen, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/mr_pleiotropy_kettunen.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_leaveoneout_shin, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/mr_leaveoneout_shin.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_leaveoneout_kettunen, "002_adiposity_metabolites/analysis/step1/WHR_Shungin_26/mr_leaveoneout_kettunen.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
