...
outcome_data_shin_clump <- read.table("002_adiposity_metabolites/analysis/step1/BMI_Locke_77/outcome_data_shin_clump.txt", header = T, sep = "\t")
outcome_data_kettunen_clump <- read.table("002_adiposity_metabolites/analysis/step1/BMI_Locke_77/outcome_data_kettunen_clump.txt", header = T, sep = "\t")
...
### save plots ====
pdf("002_adiposity_metabolites/analysis/step1/BMI_Locke_77/plot_mr_scatter_shin_clump.pdf")
for (i in 1:length(plot_mr_scatter_shin_clump)) {
  print(plot_mr_scatter_shin_clump[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/BMI_Locke_77/plot_singlesnp_forest_shin_clump.pdf")
for (i in 1:length(plot_singlesnp_forest_shin_clump)) {
  print(plot_singlesnp_forest_shin_clump[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/BMI_Locke_77/plot_leaveoneout_forest_shin_clump.pdf")
for (i in 1:length(plot_leaveoneout_forest_shin_clump)) {
  print(plot_leaveoneout_forest_shin_clump[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/BMI_Locke_77/plot_mr_funnel_shin_clump.pdf")
for (i in 1:length(plot_mr_funnel_shin_clump)) {
  print(plot_mr_funnel_shin_clump[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/BMI_Locke_77/plot_mr_scatter_kettunen_clump.pdf")
for (i in 1:length(plot_mr_scatter_kettunen_clump)) {
  print(plot_mr_scatter_kettunen_clump[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/BMI_Locke_77/plot_singlesnp_forest_kettunen_clump.pdf")
for (i in 1:length(plot_singlesnp_forest_kettunen_clump)) {
  print(plot_singlesnp_forest_kettunen_clump[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/BMI_Locke_77/plot_leaveoneout_forest_kettunen_clump.pdf")
for (i in 1:length(plot_leaveoneout_forest_kettunen_clump)) {
  print(plot_leaveoneout_forest_kettunen_clump[[i]])
}
dev.off()

pdf("002_adiposity_metabolites/analysis/step1/BMI_Locke_77/plot_mr_funnel_kettunen_clump.pdf")
...
## Save output ====
write.table(exposure_data_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/exposure_data_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(harmonise_data_shin_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/harmonise_data_shin_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(harmonise_data_kettunen_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/harmonise_data_kettunen_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_results_shin_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/mr_results_shin_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_results_kettunen_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/mr_results_kettunen_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_singlesnp_shin_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/mr_singlesnp_shin_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_singlesnp_kettunen_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/mr_singlesnp_kettunen_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_hetrogeneity_shin_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/mr_hetrogeneity_shin_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_hetrogeneity_kettunen_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/mr_hetrogeneity_kettunen_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_pleiotropy_shin_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/mr_pleiotropy_shin_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_pleiotropy_kettunen_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/mr_pleiotropy_kettunen_clump
            .txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_leaveoneout_shin_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/mr_leaveoneout_shin_clump.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
write.table(mr_leaveoneout_kettunen_clump, "002_adiposity_metabolites/analysis/step1/BMI_Locke_77/mr_leaveoneout
            _kettunen_clump
            .txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
